...
namespace Proyecto_LFA
{
    public partial class Form1 : Form
    {
        ...
        private void lblTET_Click(object sender, EventArgs e)
        {

        }

        private void lblTFollow_Click(object sender, EventArgs e)
        {

        }

        private void lblTFLN_Click(object sender, EventArgs e)
        {

        }

        private void txbExpresion_TextChanged(object sender, EventArgs e)
        {

        }

        private void lbl_TituloER_Click(object sender, EventArgs e)
        {

        }

        private void txbRuta_TextChanged(object sender, EventArgs e)
        {
